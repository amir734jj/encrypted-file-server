...
{
    /// <inheritdoc />
    public partial class AddAccessTickets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccessTickets_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    BackendHost = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    BackendPort = table.Column<int>(type: "integer", nullable: false),
                    BackendUsername = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataSourceFrontends", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataSourceFrontends_DataSources_DataSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IvBase64 = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EncryptedFiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EncryptedFiles_DataSources_DataSourceId",
                        column: x => x.DataSourceId,
                        principalTable: "DataSources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessTickets_ExpiresAt",
                table: "AccessTickets",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_AccessTickets_UserId",
                table: "AccessTickets",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessTickets_Username",
                table: "AccessTickets",
                column: "Username",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataSourceFrontends_DataSourceId",
                table: "DataSourceFrontends",
                column: "DataSourceId");

            migrationBuilder.CreateIndex(
                name: "IX_DataSources_UserId_Name",
                table: "DataSources",
                columns: new[] { "UserId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EncryptedFiles_DataSourceId",
